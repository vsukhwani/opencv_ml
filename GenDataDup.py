...
asciiValueForNum = {'0': '48','1': '49', '2': '50','3': '51', '4': '52','5': '53', '6': '54','7': '55', '8': '56','9': '57'}
rootdir ='trainingImages'
...
def main():
    ...
    for subdir, dirs, files in os.walk(rootdir):
        for file in files:
            ...
            imgTrainingNumbers = cv2.imread(os.path.join(subdir, file))            # read in training numbers image
            ...
            for npaContour in npaContours:                          # for each contour
                if cv2.contourArea(npaContour) > MIN_CONTOUR_AREA:          # if contour is big enough to consider
                    ...
                    intChar=ord(file[file.find('_')+1:-4])
                    asciiValue = asciiValueForNum[file[file.find('_')+1:-4]]                     # get key press
                    if intChar in intValidChars:      # else if the char is in the list of chars we are looking for . . .
                        intClassifications.append(asciiValue)                                                # append classification char to integer list of chars (we will convert to float later before writing to file)
